...
nonisolated final class WayGraphStore<Region: DownloadableRegion> {
    ...
    /// heruntergeladen - für die Speicherplatz-Übersicht in `SettingsView` (bewusst die echte
    /// Dateigröße statt `DownloadableRegion.approximateSizeMB`, das nur eine Vor-Download-Schätzung
    /// ist).
