...
struct HowItWorksView: View {
    ...
    private let topics: [Topic] = [
        ...
        Topic(
            ...
            text: "In den Einstellungen unter \"Offline-Karten\" lädst du deutsche Bundesländer sowie zahlreiche europäische Länder für die direkte Fahrrad-Route herunter. In heruntergeladenen Regionen bevorzugt die App automatisch ruhige Wege und Radwege statt nur der kürzesten Verbindung, zeigt echte Abbiege-Hinweise mit Straßennamen und funktioniert komplett offline - auch über mehrere heruntergeladene Regionen hinweg, indem sie automatisch den gemeinsamen Grenzübergang findet. Fehlt eine beteiligte Region, berechnet die App die Strecke stattdessen online. Bei der direkten Route lässt sich zusätzlich zur ruhigen Offline-Route per Wischen die Online-Route (meist die direkteste Verbindung, ohne Bevorzugung ruhiger Wege) einblenden und auswählen. Über das Balken-Symbol neben \"Ruhige Route (offline)\" siehst du außerdem, wie sich die Strecke auf Wegearten verteilt - z. B. wie viele Kilometer auf Radwegen statt auf Landstraßen liegen."
        ),
        Topic(
