...
- [ ] **Fußweg-/Treppen-Abkürzungen: Rebuild für die übrigen 145 Regionen aussteht** (s. o.,
      ...
      **Nordrhein-Westfalen** (593 MB), **Hessen** (301 MB), **Rheinland-Pfalz** (282 MB). Restliche
      9 Bundesländer sowie alle europäischen Länder/Regionen brauchen denselben
      `build_way_graph_v2.py`-Rebuild + Upload (`gh release upload way-graphs-v5`/`way-graphs-eu-v1`
      `--clobber`), sonst bleibt die neue Kategorie dort leer, die Schalter wirkungslos, und
      Fußgängerzonen werden in den anderen 145 Regionen weiterhin uneingeschränkt befahren. Nach
