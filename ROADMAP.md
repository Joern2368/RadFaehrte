...
- [ ] **Fußweg-/Treppen-Abkürzungen: Rebuild für die übrigen 141 Regionen aussteht** (s. o.,
      ...
      **Schleswig-Holstein** (108 MB). Restliche 5 Bundesländer sowie alle europäischen
      Länder/Regionen brauchen denselben `build_way_graph_v2.py`-Rebuild + Upload (`gh release
      upload way-graphs-v5`/`way-graphs-eu-v1` `--clobber`), sonst bleibt die neue Kategorie dort
      leer, die Schalter wirkungslos, und Fußgängerzonen werden in den anderen 141 Regionen
      weiterhin uneingeschränkt befahren. Nach etabliertem Workflow angehen:
